<header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
    <div class="flex items-center">
        ...
        <div class="relative mx-4 lg:mx-0" x-data="{ searchQuery: '' }" x-ref="searchContainer">
    ...
    <div class="flex items-center">
        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <div x-cloak x-show="dropdownOpen" class="absolute right-0 z-10 mt-2 origin-top-right rounded-md shadow-lg w-44">
                <div class="py-1 bg-white rounded-md shadow-xs">
                    <a href="#" class="block px-4 py-2 text-gray-800">Profile</a>
                    <a href="#" class="block px-4 py-2 text-gray-800">Settings</a>
                    <form method="POST" action="#">
                        <button type="submit" class="block w-full px-4 py-2 text-left text-gray-800">Logout</button>
                    </form>
                </div>
            </div>
        </div>
