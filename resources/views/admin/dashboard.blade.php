            ...
            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    <div class="p-3 rounded-full bg-orange-600 bg-opacity-75">
                        <svg class="h-8 w-8 text-white" viewBox="0 0 28 28" fill="none" xmlns="../pngegg.png">
 ...
 <x-admin-layout>
    <div class="bg-white p-4 mb-4 border-2 border-white rounded-lg">
        ...
        <div class="overflow-x-auto">
            <ul class="flex flex-nowrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                @for ($i = 1; $i <= 18; $i++)
                    <li class="me-2">
                        <a href="javascript:void(0)" id="tab-{{ $i }}"
                            class="tab-link inline-block duration-500 p-6 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300 min-w-[50px] whitespace-nowrap"
            ...
            <button class="px-4 py-2 mb-2 bg-orange-600 rounded-md text-white font-medium tracking-wide hover:bg-orange-500">Tambah</button>
        <div id="periode1" class="tab-content hidden">
        ...
        <div id="periode2" class="tab-content hidden">
            <section class="bg-white dark:bg-gray-900">
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    <table class="min-w-full">
